...
const CharacterList = () => {
  ...
  return (
    <section className="grid grid-cols-1 justify-items-center md:grid-cols-2 lg:grid-cols-3 gap-2 md:max-h-[calc(100vh-350px)] lg:max-h-[calc(100vh-300px)] sm:max-h-[calc(100vh-160px)] p-2 overflow-y-auto">
      {chars.map((c) => {
